  ...
  return (
    <>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="mt-12">
          <ProductTabs care={`Light: Bright indirect light. Water: Every 2 weeks.`} description={product.title || "<p>No description</p>"} shipping={"Shipping within 3-5 business days."} />
        </div>
